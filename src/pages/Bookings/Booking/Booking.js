...
const [singleSevice,setSingleService]=useState({})
    useEffect(()=>{
        fetch(`https://desolate-shelf-59541.herokuapp.com/services/${serviceId}`)
        .then(res => res.json())
        .then(data => {
            console.log(data);
    ...
    const onSubmit = data => {
        if (confirm("Are you sure you want to book now??")) {
            ...
            axios.post('https://desolate-shelf-59541.herokuapp.com/bookingRequests', data, data.status = "Pending")
                .then(res => {
                    reset();
                })
        }
    ...
    return (
        ...
        <div className="container text-dark">
            ...
            <hr className="mx-auto"
                style={{ width: '25%', alignItems: 'center', color: 'primary' }}
            />
            <div className="row">
                <div className=" col-sm-1 col-lg-6 g-4 text-dark">
                    <Card className="card">
                ...
                <div className="col-sm-1 col-lg-6 g-4">
                    <Card className="card h-100">
                        <Card.Body className="booking-info mx-s">
                            <h4 className="text-center text-primary">Book Now</h4>
